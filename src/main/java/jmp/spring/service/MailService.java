...
//		
		String mail_id = prop.getProperty("pjjjj865@gmail.com"); //아이디
		String mail_pw = prop.getProperty("saoyjaajmktzqwxg"); //앱비번
		...
		try {
			...
			// 발송자 설정 (발송자의 메일, 발송자명)
			msg.setFrom(new InternetAddress("pjjjj865@gmail.com", "오늘"));
             // 수신자 설정 
